...
contextBridge.exposeInMainWorld("novelHost", {
  ...
  readProjectProseStyle: () => ipcRenderer.invoke("memory:readProjectProseStyle"),
  writeProjectProseStyle: (content) => ipcRenderer.invoke("memory:writeProjectProseStyle", content),
  readProjectDescriptionStats: () => ipcRenderer.invoke("memory:readProjectDescriptionStats"),
  writeProjectDescriptionStats: (content) => ipcRenderer.invoke("memory:writeProjectDescriptionStats", content),
  readProjectStoryDatabase: () => ipcRenderer.invoke("memory:readProjectStoryDatabase"),
  writeProjectStoryDatabase: (content) => ipcRenderer.invoke("memory:writeProjectStoryDatabase", content),
  readProjectRealtimeDatabase: () => ipcRenderer.invoke("memory:readProjectRealtimeDatabase"),
  writeProjectRealtimeDatabase: (content) => ipcRenderer.invoke("memory:writeProjectRealtimeDatabase", content),
